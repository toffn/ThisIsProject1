...
function preload()//Initialize main img variables + list of images to alternate from
var cardNumber;
var card;
var card1;
var card2;
...
function stateCardOfTheDay()
{
	...
	image(CoTD, 500, 225);
	textSize(16);
	text("Card of the Day:", 500, 35);
	textSize(12);
	text("INTERPRETATION:", 500, 430);
	text(CoTDdesc, 500, 455);
...
function statePastPresentFuture()
{
	...
	textSize(16);
	text("(Left to Right) Past, Present, Future:", 500, 35);
	textSize(12);
	text("INTERPRETATION:", 500, 430);
	text("CONTEXT: " + card1desc, 500, 455);
	text("CURRENT THEMES: " + card2desc, 500, 475);
...
function stateMindBodySpirit()
{
	...
	textSize(16);
	text("(Left to Right) Mind, Body, Spirit:", 500, 35);
	textSize(12);
	text("INTERPRETATION:", 500, 430);
	text("THINGS TO RE-EVALUATE: " + card1desc, 500, 455);
	text("BE AWARE OF: " + card2desc, 500, 475);
...
function stateChallengeSolution()
{
	...
	textSize(16);
	text("(Left to Right) Challenge and Solution:", 500, 35);
	textSize(12);
	text("INTERPRETATION:", 500, 430);
	text("THE CHALLENGE AT HAND: " + card1desc, 500, 455);
	text("THE KEY TO RESOLVING IT: " + card2desc, 500, 475);
